...
//        menu.addView(new RentaLineChartView(ui.service, ui.rentaHistoryService, ui.vehicleService), RentaLineChartView.NAME, RentaLineChartView.NAME, new ThemeResource("img/barChartPNG.png"));
